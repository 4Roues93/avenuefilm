	...
	<div class="container">
	   <div id="content" class="row">
		...
		<?php
			...
			$reponse = $bdd->query("SELECT * FROM films WHERE categorie='DiversF' ORDER BY titre ASC LIMIT ".(($depart-1)*$nombre_max_page).",$nombre_max_page" );
		...
		<section class="col-sm-4" table-responsive">
			...
			<dd><div class="col-lg-2"><p style="border:1px white solid;">Date de sortie :<br><?php echo $donnees['date'];?></p></div>
				<dd class="col-sm-12">
...
<?php
    ...
    <div id="page_navigation"> 
			Page :
		<?php
			$total_tab = $bdd->query("SELECT COUNT(*) AS total FROM films WHERE categorie='DiversF' ORDER BY titre ASC");
			...
			for($i = 1; $i <= $nombreDePages; $i++){
				echo " <a href=\"DiversF.php?p=$i\"> $i - </a>";
			}
		?>
	</div>
</div>
