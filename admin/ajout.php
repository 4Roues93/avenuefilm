...
<html>
  ...
  <body><br><br><br><br>
	...
	<div class="container">
	<div class="demande">
		<form action="ajoutpost.php" method="POST" enctype="multipart/form-data">
			<div class="form-group">
			<p><a href="#">Modifier vidéos</a> | <a href="#">Supprimer vidéo</a> | <a href="nomfichier.php">ajout nom fichier</a></p>
			...
			<div class="form-group">
				<label for="video">Ajout film :</label><br>
